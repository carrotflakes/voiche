...
export class Processor {
    ...
    */
    process(buffer) {
        ...
        wasm.processor_process(this.__wbg_ptr, ptr0, len0, addHeapObject(buffer));
    }
    /**
    * @param {number} pitch
    */
    set_pitch(pitch) {
        wasm.processor_set_pitch(this.__wbg_ptr, pitch);
    }
    /**
    * @param {number} formant
    */
    set_formant(formant) {
        wasm.processor_set_formant(this.__wbg_ptr, formant);
    }
}
